...
export default function Footer() {
    ...
    return (
        <footer className="bg-background text-foreground flex flex-col items-center justify-center py-5 pt-15 z-50 relative px-3">
            <div className="container flex flex-col gap-4 lg:px-5">
                <div className="flex w-full flex-col gap-8 lg:flex-row">
                    <div className="flex w-full flex-col gap-2 text-center lg:w-1/3 lg:text-left">
                        <h3 className="text-3xl text-primary font-bold">{Config.appName}</h3>
                ...
                <hr className="my-4 w-full opacity-20" />
                <div className="flex flex-col gap-8 lg:flex-row">
                    <div className="flex w-full flex-col items-center px-6 text-center lg:w-1/3 lg:items-start lg:px-0 lg:text-left">
                        ...
                        <p className="mt-2 w-full text-sm lg:w-2/3">Join with us for an unforgettable travel experience.</p>
                    ...
                    <div className="flex w-full flex-col items-center text-center lg:w-1/3 lg:items-end lg:text-left">
                        ...
                        <p className="text-sm text-wrap">{Config.contact.address}</p>
                ...
                <div className="flex w-full flex-col items-center justify-center gap-2 md:flex-row lg:items-end">
                    <p className="flex-1 text-md">
                        {Config.appName} {new Date().getFullYear()} &copy; All right reserived!
                    </p>
                    <p className="flex-1 text-end">
                        Powered by{' '}
                        <Link className="text-secondary-foreground" href={Config.appCompanyUrl}>
                            {Config.appCompany}
                        </Link>
                    </p>
                </div>
